			...
			<tbody>
				<tr>
					...
					<td>
						...
						<b class="text-success fw-bold">Correct answer: <?php echo $rows['correct_ans']; ?><?php if ($rows['correct_ans']=='A') {echo $rows['option_a']; }elseif ($rows['correct_ans']=='B') {echo $rows['option_b']; }elseif ($rows['correct_ans']=='C') {echo $rows['option_c']; }elseif ($rows['correct_ans']=='D') {echo $rows['option_d']; } ?></b><br>
					</td>
				</tr>
			</tbody>
		</table>
