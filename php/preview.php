                    ...
                    <div class="col-lg-10 mx-auto">
                                            ...
                                            <table class="align-middle mb-0 table table-borderless">
                                                ...
                                                <tbody style="font-size: 17px;">
                                                    <tr>
                                                        ...
                                                        <th><span>
                                                                <p class="d-flex justify-content-end"><span><i class="fas fa-asterisk fa-xs text-danger me-1"></i></span> 1 point</p>
                                                            </span></th>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            ...
                            <?php
					            ...
					            ?>
                            <input type="submit" name="trial_quiz" value="submit" class="btn btn-success px-5 pb-2 mx-2 text-uppercase btn-lg">
                        </div>
                    </div>
                </form>
            </div>
