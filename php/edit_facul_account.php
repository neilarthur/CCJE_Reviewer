...
?>
        ...
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 py-2 fw-bold">
        ...
        <div class="col-xl-3 col-lg-5 col-md-12 col-sm-12 py-2">
          <label for="user-age" class="d-flex justify-content-center ps-1 fw-bold">Age</label>
          <input type="number" name="age" class="form-control text-center" value="<?php echo $row['age']; ?>">
        </div>
        <div class="col-xl-3 col-lg-5 col-md-12 col-sm-12 py-2">
          <label for="user-section" class="d-flex ps-1 fw-bold">Year & Section</label>
    ...
    <div class="modal-footer border-0 mt-3 d-flex justify-content-center">
      <button type="submit" name="save" class="btn btn-success px-4 pb-2 text-white"><i class="fas fa-save me-2"></i>Save Changes</button>
