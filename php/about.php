		...
		<div class="row">
			<div class="col-md-6">
				<div class="card" style="padding-left: 50px; padding-right: 50px;">
					<div class="card-body">
						<h1 class="fw-bold mb-5" style="font-family: 'Source Sans Pro', sans-serif; color: #8C0000;">About Us</h1>
						<h2 class=" fw-bold mb-4" style="font-family: 'Source Sans Pro', sans-serif;">LSPU Quality Policy</h2>
							<p class="mt-3 lh-base" style="text-align: justify;">LSPU delivers quality education through responsive 
					        ...
					        <h2 class=" fw-bold mb-4" style="font-family: 'Source Sans Pro', sans-serif;">Vision</h2>
					        <p class="mt-3 lh-base" style="text-align: justify;">The Laguna State Polytechnic University is a center of sustainable development transforming lives and communities.</p>


					        <h2 class=" fw-bold mb-4" style="font-family: 'Source Sans Pro', sans-serif;">Mission</h2>
					        <p class="mt-3 lh-base" style="text-align: justify;">LSPU provides quality education through responsive instruction, distinctive research, and sustainable extension and production services for improved 
					        quality of life towards nation building.</p>

					        <h2 class=" fw-bold mb-4" style="font-family: 'Source Sans Pro', sans-serif;">History of LSPU</h2>
					        <p class="mt-3 lh-base" style="text-align: justify;">This state institution (LSPU) started from its humble beginnings in 1952. It was first established as a provincial high school known as Baybay Provincial High School, the first public high school based in the shoreline (baybay) district of Laguna de Bay, and the second in the whole Province of Laguna. Then in 1957, by virtue of Republic Act No. 1807 on June 1957, the Baybay Provincial High School was converted into Baybay National Agricultural and Vocational School (BNAVS).</p>

							<p class="mt-3 lh-base" style="text-align: justify;">BNAVS became the PACD-BVE Training Center in rice production for American Peace Corps Volunteers. This center produced 682 graduates. The Manpower Training Center Started to operate in the school year 1968-1969. BNAVS also became the pilot school for the 2-year Agricultural Technician Curriculum, Associate in Agriculture. This started in December 1969 with eight enrollees.</p>

							<p class="mt-3 lh-base" style="text-align: justify;">With the passage/approval of HB 269 into law in June 1971: Republic Act No. 6321, it converted BNAVS into Baybay National College of Agriculture and Technology (BNCAT). BNCAT then was offering the following courses:</p>

							<p>&bull; Secondary Agriculture Curriculum</p>
							<p>&bull; Two-year Associate in Agriculture (technical course)</p>
							<p>&bull; Degree courses leading to Bachelor of Science in Agriculture (2nd Semester 1975-76) and Bachelor of Science in Agricultural Education (First Semester 1977-78)</p>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="card">
					<div class="card-body">
						<div class="text-center">
							<img class="img-fluid center" alt="" id="picture" src="../assets/pics/old.jpg "width="600" height="500"/>
						</div>
					</div>
				</div>
			</div>
