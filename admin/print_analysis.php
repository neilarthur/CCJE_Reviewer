...
$pdf ->setFont('Arial','U',10);
$pdf ->Cell(190 ,-10, 'Section: 4A',100,100,'C');
...
$accounts_result = "SELECT * FROM tbl_exam_result,accounts,tbl_pre_question WHERE (tbl_exam_result.acc_id = accounts.acc_id) AND (tbl_exam_result.pre_exam_id = tbl_pre_question.pre_exam_id) AND (tbl_exam_result.pre_exam_id = '{$_GET['id']}') AND (accounts.section='4A') ORDER BY accounts.last_name ASC";
...
$pdf ->setFont('Arial','U',10);
$pdf ->Cell(190 ,-10, 'Section: 4C',100,100,'C');
...
$accounts_result = "SELECT * FROM tbl_exam_result,accounts,tbl_pre_question WHERE (tbl_exam_result.acc_id = accounts.acc_id) AND (tbl_exam_result.pre_exam_id = tbl_pre_question.pre_exam_id) AND (tbl_exam_result.pre_exam_id = '{$_GET['id']}')  AND (accounts.section='4C') ORDER BY accounts.last_name ASC";
