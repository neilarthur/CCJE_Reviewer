...
if (isset($_POST['save'])) {
	...
	if ($sql_run) {
		...
		$local = "INSERT INTO tbl_admin_response(response_sender,acc_id,pre_exam_id,notif_stat_student) VALUES ('$act','$prepared_by','$update_id','$act_stat')";
		$base = mysqli_query($sqlcon,$local);

		if ($base) {


			$let = "INSERT INTO tbl_admin_response(response_sender,acc_id,pre_exam_id,notif_stat_student) VALUES ('$act2','$prepared_by','$update_id','$act_stat')";
