                                    ...
                                    <table class="table align-middle bg-light m-2" width="100%" id="preboardTab">
                                        ...
                                        <tbody>
                                            <?php
                                                    ...
                                                    $locks = mysqli_query($sqlcon,"SELECT * FROM accounts,tbl_pre_question WHERE (accounts.acc_id = tbl_pre_question.prepared_by) AND tbl_pre_question.pre_board_status='archive'");
                                                    ...
                                                    while ($rows = mysqli_fetch_assoc($locks)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="../php/del_board_system.php?enabled=<?= $rows['pre_exam_id']; ?>" class="btn btn-success mx-3 btn-del py-2" ><i class="fas fa-trash-restore"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
