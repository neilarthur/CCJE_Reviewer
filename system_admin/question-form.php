...
<body style="background-color: rgb(229, 229, 229);">
						...
						<div class="container-fluid">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="testbank.php" style="text-decoration: none;">Question Bank</a></li>
    ...
    <?php $come = mysqli_query($sqlcon,"SELECT * FROM tbl_response  WHERE response_stat='0' ORDER BY response_id DESC");
			...
			<div class="col p-3 overflow-auto">
				<div class="container-fluid ">
					<form action="../php/question_add_admin.php" method="POST" id="add_form">
												...
												<div class="row">
													<div class="col-md-6">
								                        <div class="input-group mb-3">
								                        	<span class="input-group-text ps-1 fw-bold bg-white">Area of Exam</span>
													...
													<div class="col-md-6">
								                        <div class="input-group mb-3">
								                        	<span class="input-group-text ps-1 fw-bold bg-white">Level of Difficulty</span>
