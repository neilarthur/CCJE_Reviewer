                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Archived User Accounts</li>
                            </ol>
                        </nav>
                    </div>
                </nav>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col d-flex justify-content">
                        <div class="w-50">
                            <h2 class="text-dark text-start ps-3 fw-bold mt-4 ms-2 ">Archived User Accounts</h2>
                        </div> 
                    </div>
                </div>
                                ...
                                <div class="card">
                                    <div class="card-body rounded-3 mx-4 table-responsive-xl">
                                        ...
                                        <table class="table table-striped align-middle bg-light" id="student">
                                            ...
                                            <tbody>
                                                <?php
                                                $query_row = mysqli_query($sqlcon,"SELECT * FROM accounts WHERE role='student' AND status = 'archive'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-row justify-content-center">
                                                            ...
                                                            <a href="../php/archiveaccount.php?enabled=<?php echo $rows['acc_id']; ?>" class="btn btn-success mx-2 btn-del"><i class="fas fa-trash-restore-alt"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                              <?php } ?>
                                    ...
                                    <div class="card-body rounded-3 m-4 table-responsive-xl">
                                        <table class="table table-striped align-middle bg-light text-align-middle" id="faculty">
                                            ...
                                            <tbody>
                                               ...
                                               $query_raw = mysqli_query($sqlcon,"SELECT * FROM accounts WHERE status='archive' AND role='faculty' OR role='secretary'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-row justify-content-center">
                                                            ...
                                                            <a href="../php/archiveaccount.php?enabled=<?php echo $raws['acc_id']; ?>" class="btn btn-success mx-2 btn-del"><i class="fas fa-trash-restore-alt"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php } ?>
...
<script type="text/javascript">
    ...
    if (flashdata) {
        ...
        Swal.fire({
            ...
            text: 'Please check the accounts tab',
        })
    }
 </script>
  <script type="text/javascript">
