								...
								<div class="card">
									<div class="card-body m-4">
										...
										<div class="d-flex justify-content-between mb-3">
											<button data-id="<?php echo $id; ?>" class="btn btn-warning px-3 pb-2 editinfo disabled" data-bs-toggle="modal" type="button"><i class="fas fa-edit"></i>
											</button>
											<div class="d-flex">
												<div class="dropdown">
												  ...
												  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
												    	...
												    	if ($lows ==$num) {
												    		...
												    		echo "<li><a class='dropdown-item disabled' href='adding-quiz-question.php?id=$id&total=$tots'><i class='fas fa-plus me-2'></i>a new Questions </a></li>
												    		<div class='dropdown-divider'></div>
	        ...
	        <div class="modal-dialog">
	            <div class="modal-content">
	                ...
	                <div class="modal-footer border-0">
	                    <form action="../php/logout.php" class="hide" method="POST">
