												...
												<tr>
													...
													<td>
														<div class="d-flex flex-row justify-content-center">
															...
															<a href="../php/archive_account_sec.php?disabled=<?php echo $rows['acc_id']; ?>" class="btn btn-secondary mx-2 btn-del"><i class="fas fa-archive"></i></a>
														</div>
													</td>
												</tr>
											  <?php } ?>
												...
												<tr>
													...
													<td>
														<div class="d-flex flex-row justify-content-center">
															...
															<a href="../php/archive_account_sec.php?disabled=<?php echo $raws['acc_id']; ?>" class="btn btn-secondary mx-2 btn-del"><i class="fas fa-archive"></i></a>
														</div>
													</td>
												</tr>
												<?php } ?>
        ...
        <div class="modal fade" id="AddFaculty"  data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        	<div class="modal-dialog modal-lg">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
        				<div class="container">
        					<form class="form" method="post" action="../php/add_account_sec.php" enctype="multipart/form-data">
        						<div class="col">
        							<div class="row">
        								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 py-2 me-5">
...
if (isset($_GET['addsuccess'])) {
	...
	window.history.pushState({}, document.title, "/" + "CCJE_Reviewer/secretary/accounts.php?tab-accounts=students");
	</script>';
}
...
elseif (isset($_GET['suc'])) {
	echo ' <script> swal("Account has been Changed!", " clicked the okay!", "success");
	window.history.pushState({}, document.title, "/" + "CCJE_Reviewer/secretary/accounts.php?tab-accounts=faculty");
	</script>';
}
