									...
									<div class="card">
										<div class="card-body rounded-3 table-responsive-xl">
											<div class="d-flex justify-content-end mb-3">
												<a href="view_exam_form.php?id=<?php echo $_GET['id'];?>&descripted=<?php echo $_GET['descript']; ?>&timer=<?php echo $_GET['time']; ?>&ac_code=<?php echo $_GET['access']; ?>&bain=<?php echo $_GET['total']; ?>&raf=<?php echo $_GET['safd']; ?>" type="submit" class="btn px-3 pb-2 text-white" style="background-color: #8C0000; border-style: none;"><b><i class="fas fa-plus"></i></b>ADD</a>
											</div>
											<table class="table table-hover align-middle bg-light" width="100%"  id="examTab">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $rows['levels_name'];?></td>
														<td>
