...
$lob_run = "SELECT first_name,acc_id FROM accounts WHERE role ='faculty' order by acc_id asc";
									...
									<div class="card-body rounded-3 table-responsive-xl">
										...
										<table class="table table-hover align-middle bg-light" width="100%" id="questTab">
											...
											<tbody>
												...
												$xams = mysqli_query($sqlcon,"SELECT * FROM accounts WHERE acc_id = '{$_SESSION['acc_id']}' AND role = 'faculty'");
