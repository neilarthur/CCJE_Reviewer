					...
					<div class="container-fluid">
						<div class="row">
							<div class="col d-flex justify-content">
								<div class="w-50">
									<h2 class="text-dark text-start ps-3 fw-bold mt-4 ms-2">Questionnaire</h2>
								</div>
							</div>
							<div class="row">
								<div class="col ">
									<div class="card">
										<div class="card-body rounded-3 table-responsive-xl">
											<div class="d-flex justify-content-end mb-3">
												<a href="../php/edit_quiz_question.php?id=<?php echo $_GET['id']?>" type="submit" class="btn px-3 pb-2 text-white" style="background-color: #8C0000; border-style: none;"><b><i class="fas fa-plus"></i></b>ADD</a>
											</div>
											<table class="table table-hover align-middle bg-light" width="100%"  id="examTab">
												...
												<tbody>
													...
													$exams = mysqli_query($sqlcon,"SELECT * FROM test_question,choose_question, student_choice WHERE (test_question.question_id=student_choice.question_id) AND (choose_question.test_id=student_choice.test_id) AND student_choice.test_id='$let' AND question_stat='active'");
													...
													<tr>
														...
														<td class="fw-bold text-success"><?php echo $rows['correct_ans'];?></td>
														<td>
