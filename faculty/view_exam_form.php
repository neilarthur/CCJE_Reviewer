						...
						<div class="card">
							<div class="card-body m-3">
								...
								<div class="mb-3">
									...
									<textarea type="text" class="form-control" name="description"  rows="2" readonly><?php echo $_GET['descripted']; ?></textarea>
								</div>
								<div class="row">
									<div class="col-sm-4">
									...
									<div class="col-sm-4">
										<div class="mb-3">
											...
											<div class="form-group">
												<select class="form-select" name="time_limit" disabled>
													<option selected><?php echo $_GET['timer']; ?> mins</option>
								...
								<div class="row">
									<div class="col-sm-4">
										...
										<div class="input-group">
											<select class="form-select" name="game" id="total_questions">
	                      					...
	                      					<select class="form-select" name="t_questions" id="total_questions"disabled>
                  								<option selected=""><?php echo $_GET['bain']; ?></option>
									...
									<div class="col-sm-4">
										<label class="form-label">Access Code</label>
											<input type="text" class="form-control" name="access_code" value="<?php echo $_GET['ac_code']; ?>" readonly>
								...
								<div class="card mt-3">
									<div class="card-body">
										...
										<div class="d-grid gap-2 d-md-flex justify-content-md-end ">
											<button type="submit" name="create" class="btn px-3 pb-2 text-white" style="background-color: #8C0000;"><i class="fas fa-plus"></i> ADD</button>
											<button type="button" class="btn btn-primary">Import</button>
										</div>
										<hr>
										<div id="fetching" class="table-responsive" >
											<table class="align-middle mb-0 table table-borderless table-striped " id="preboardTab">
											    <thead>
											      <tr>
