...
while ($rows = mysqli_fetch_assoc($view_code)) { ?>
	...
	<form action="function_response.php" method="POST">
        <div class="form-group d-flex justify-content-center">
            ...
            <textarea type="text" class="form-control " name="response" rows="7" required></textarea>
            
        </div>
        <div class="modal-footer d-flex justify-content-center border-0">
            <input type="submit" name="subs" class="btn btn-success px-5 pb-2 text-white" value="Enter">
        </div>
    </form>
<?php } ?>